...
export default function VendorNavbar() {
  ...
  const handleSignOut=async()=>{
    ...
    router.push("/v1/EntreFlow/Employee/vendor/login")
  }
  return (
    <>
           ...
           {Navbar ?  <Navbar.Offcanvas
            ...
            >
              ...
              <Offcanvas.Body>
                ...
                <Nav.Link className={`mx-3 ${style.menu} `}><Link href={"vendorDashboard"}>Products</Link></Nav.Link>
                  <Nav.Link className={`mx-3 ${style.menu} `}><Link href={"VendorCustomers"}>Customers</Link></Nav.Link>
                  <Nav.Link className={`mx-3 ${style.menu} `}><Link href={"VendorEmployees"}>Employees</Link></Nav.Link>
...
<Link href="VendorProfile">Profile</Link>
                    </NavDropdown.Item>
